...
class AuthRepository {
  ...
  Future loginNew(String email, String password) async {
    ...
    try {
      ...
      final body =
          jsonDecode(response.body); // ✅ Decodifica correctamente el JSON
    ...
    if (body.containsKey('token')) {
      final user = Login(
        ...
        branch: Branch.fromJson(
            body['branch'] as Map<String, dynamic>), // ✅ Conversión correcta
      );
